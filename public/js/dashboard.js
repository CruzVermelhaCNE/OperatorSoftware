...
feather = __webpack_require__(/*! feather-icons */ "./node_modules/feather-icons/dist/feather.js");
feather.replace(); //Notifications
...
function callNotifications() {
  $.getJSON('/data/missed_calls.json', function (object) {
    var count = object.data.length;

    if (count > 0) {
      var notification_text = 'Existem ' + count + ' Chamadas Perdidas';
  ...
  $.getJSON('/data/callbacks.json', function (object) {
    ...
    if (count > 0) {
      var notification_text = 'Existem ' + count + ' Chamadas Por Devolver';
      sendNotification(notification_text);
    }
  });
}
...
module.exports = __webpack_require__(/*! C:\Users\miguel.santos\Desktop\Informática\OperatorSoftware\resources\js\dashboard.js */"./resources/js/dashboard.js");
