...
<div class="container">
    ...
    <form method="POST"
        action="{{$coordination?route('goi.coordination.edit',["id"=>$theater_of_operations->id,"coordination_id"=>$coordination->id]):route('goi.coordination.create',$theater_of_operations->id)}}">
        @else
        @endif
        @csrf
        @if ($coordination)
        ...
        <a class="btn btn-danger"
            href="{{route('goi.coordination.remove',["id"=>$theater_of_operations->id,"coordination_id"=>$coordination->id])}}">Apagar</a>
        @endif
        @else
        @endif
    </form>
