...
<div class="container">
    ...
    <form method="POST"
        action="{{$crew?route('goi.crews.edit',["id"=>$theater_of_operations->id,"crew_id"=>$crew->id]):route('goi.crews.create',$theater_of_operations->id)}}">
        @else
        @endif
        @csrf
        @if ($crew)
        ...
        <a class="btn btn-info"
            href="{{route('goi.crews.single',["id"=>$theater_of_operations->id,"crew_id" => $crew->id])}}">Voltar</a>
