...
<div class="container">
    ...
    <form method="POST"
        action="{{$unit?route('goi.units.edit',["id"=>$theater_of_operations->id,"unit_id"=>$unit->id]):route('goi.units.create',$theater_of_operations->id)}}">
        @else
        @endif
        @csrf
        @if ($unit)
        ...
        <a class="btn btn-info"
            href="{{route('goi.units.single',["id"=>$theater_of_operations->id,"unit_id" => $unit->id])}}">Voltar</a>
        @else
