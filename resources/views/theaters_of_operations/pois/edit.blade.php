...
<div class="container">
    ...
    <form method="POST"
        action="{{$poi?route('theaters_of_operations.pois.edit',["id"=>$theater_of_operations->id,"poi_id"=>$poi->id]):route('theaters_of_operations.pois.create',$theater_of_operations->id)}}">
        @else
        @endif
        @csrf
        @if ($poi)
        ...
        <a class="btn btn-danger"
            href="{{route('theaters_of_operations.pois.remove',["id"=>$theater_of_operations->id,"poi_id"=>$poi->id])}}">Apagar</a>
        @endif
        @else
        @endif
    </form>
