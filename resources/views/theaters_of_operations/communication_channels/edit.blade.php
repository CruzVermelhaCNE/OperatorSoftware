...
<div class="container">
    ...
    <form method="POST"
        action="{{$communication_channel?route('theaters_of_operations.communication_channels.edit',["id"=>$theater_of_operations->id,"communication_channel_id"=>$communication_channel->id]):route('theaters_of_operations.communication_channels.create',$theater_of_operations->id)}}">
        @else
        @endif
        @csrf
        @if ($communication_channel)
        ...
        <a class="btn btn-danger"
            href="{{route('theaters_of_operations.communication_channels.remove',["id"=>$theater_of_operations->id,"communication_channel_id"=>$communication_channel->id])}}">Apagar</a>
        @endif
        @else
        @endif
    </form>
