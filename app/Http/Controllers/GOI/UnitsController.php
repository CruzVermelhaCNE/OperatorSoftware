...
use App\Http\Requests\GOI\TheaterOfOperationsUnitAssignToPOI;
use App\Http\Requests\GOI\TheaterOfOperationsUnitCreate;
use App\Http\Requests\GOI\TheaterOfOperationsUnitCreateCommunicationChannel;
use App\Http\Requests\GOI\TheaterOfOperationsUnitCreateGeotracking;
use App\Http\Requests\GOI\TheaterOfOperationsUnitEdit;
use App\Http\Requests\GOI\TheaterOfOperationsUnitRecreate;
use App\Http\Requests\GOI\TheaterOfOperationsUnitUpdateCommunicationChannel;
use App\Http\Requests\GOI\TheaterOfOperationsUnitUpdateGeotracking;
use App\Http\Requests\GOI\TheaterOfOperationsUnitUpdateObservations;
use App\Http\Requests\GOI\TheaterOfOperationsUnitUpdateStatus;
use App\Models\GOI\TheaterOfOperationsEventVictim;
use App\Models\GOI\TheaterOfOperationsUnit;
use App\Models\GOI\TheaterOfOperationsUnitCommunications;
...
class UnitsController extends Controller
{
    ...
    public function single($id, $unit_id)
    {
        ...
        return view('goi.units.single', ['unit' => $unit]);
    }
    ...
    public function edit(TheaterOfOperationsUnitEdit $request)
    {
        ...
        $unit->theater_of_operations->resetUnitsListing();
        return redirect()->route('goi.units.single', ['id' => $unit->theater_of_operations->id, 'unit_id' => $unit->id]);
    }
    ...
    public function demobilize($id, $unit_id)
    {
        ...
        $unit->demobilize();
        $unit->theater_of_operations->resetUnitsListing();
        return redirect()->route('goi.single', $unit->theater_of_operations->id);
    }
}
