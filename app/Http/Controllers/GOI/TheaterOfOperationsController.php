...
use App\Models\GOI\TheaterOfOperationsCommunicationChannel;
...
class TheaterOfOperationsController extends Controller
{
    public function create(TheaterOfOperationsCreate $request)
    {
        ...
        return redirect()->route('goi.single', $theater_of_operations->id);
    }
    ...
    public function single($id)
    {
        ...
        return view('goi.single', ['theater_of_operations' => $theater_of_operations]);
    }

    public function unit_redirect($unit_id)
    {
        $unit = TheaterOfOperationsUnit::findOrFail($unit_id);
        return redirect()->route('goi.units.single', ['id' => $unit->theater_of_operations->id, 'unit_id' => $unit_id]);
    }

    public function event_redirect($event_id)
    {
        $event = TheaterOfOperationsEvent::findOrFail($event_id);
        return redirect()->route('goi.event.single', ['id' => $event->theater_of_operations->id, 'event_id' => $event_id]);
    }

    public function poi_redirect($poi_id)
    {
        $poi = TheaterOfOperationsPOI::findOrFail($poi_id);
        return redirect()->route('goi.single', ['id' => $poi->theater_of_operations->id]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('goi.edit', ['theater_of_operations' => $theater_of_operations]);
    }
    ...
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        return view('goi.coordination.edit', ['coordination' => null,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function editCoordination($id, $coordination_id)
    {
        ...
        return view('goi.coordination.edit', ['coordination' => $coordination,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        return view('goi.pois.edit', ['poi' => null,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function editPOI($id, $poi_id)
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        $poi                   = TheaterOfOperationsPOI::findOrFail($poi_id);
        return view('goi.pois.edit', ['poi' => $poi,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        return view('goi.events.edit', ['event' => null,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function editEvent($id, $event_id)
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        $event                 = TheaterOfOperationsEvent::findOrFail($event_id);
        return view('goi.events.edit', ['event' => $event,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        return view('goi.units.edit', ['unit' => null,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function recreateUnit($id)
    {
        ...
        return view('goi.units.recreate', ['deleted_units' => $deleted_units,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function editUnit($id, $unit_id)
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        $unit                  = TheaterOfOperationsUnit::findOrFail($unit_id);
        return view('goi.units.edit', ['unit' => $unit,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        return view('goi.crews.edit', ['crew' => null,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function recreateCrew($id)
    {
        ...
        return view('goi.crews.recreate', ['deleted_crews' => $deleted_crews,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function editCrew($id, $crew_id)
    {
        ...
        return view('goi.crews.edit', ['crew' => $crew,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    {
        $theater_of_operations = TheaterOfOperations::findOrFail($id);
        return view('goi.communication_channels.edit', ['communication_channel' => null,'theater_of_operations' => $theater_of_operations]);
    }
    ...
    public function editCommunicationChannel($id, $communication_channel_id)
    {
        ...
        return view('goi.communication_channels.edit', ['communication_channel' => $communication_channel,'theater_of_operations' => $theater_of_operations]);
    }
