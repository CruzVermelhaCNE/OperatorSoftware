...
namespace App\Http\Controllers\TheatersOfOperations\Events;
...
class VictimsController extends Controller
{
    public function create($id, $event_id)
    {
        ...
        $event->resetVictims();
        return redirect()->route('theaters_of_operations.events.single', ['id' => $event->theater_of_operations->id, 'event_id' => $event->id]);
    }
    ...
    public function delete($id, $event_id, $victim_id)
    {
        ...
        return redirect()->route('theaters_of_operations.events.single', ['id' => $victim->event->theater_of_operations->id, 'event_id' => $victim->event->id]);
    }
}
